                ...
                >
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="h-12 transition-all duration-200 bg-gray-50/50 border-gray-200 focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent pl-10"
                      required
                    />
